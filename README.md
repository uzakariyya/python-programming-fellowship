...
|      | -    | Functions (Defining functions, arguments, return values, and passing lists to functions).       | -                              | -                                             | [Function1](https://github.com/arewadataScience/30-Days-of-Python/blob/main/09_Module_Functions_List_Comprehensions/09_functions_list_comprehensions.md)      |
