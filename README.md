...
| 4    | -  | User Input and while Loops (Handling user input, `while` loops, break and continue statements). | -                              | -                                             | [Loops](https://github.com/arewadataScience/30-Days-of-Python/blob/main/08_Module_Loops/08_loops.md)      |
|      | -    | Functions (Defining functions, arguments, return values, and passing lists to functions).       | -                              | -                                             | [Function1](https://github.com/arewadataScience/30-Days-of-Python/blob/main/09_Module_Functions_List_Comprehensions/09_functions_list_comprehensions.md) \| [Function2](https://github.com/arewadataScience/30-Days-of-Python/blob/main/10_Module_Higher_order_functions/10_higher_order_functions.md)     |
| 5    | -  | Classes (Defining classes, attributes, methods, and working with objects).                     | -                              | -                                             | [Classes](https://github.com/arewadataScience/30-Days-of-Python/blob/main/16_Module_Classes_and_objects/16_classes_and_objects.md)     |
|      | -    | Continuation (Inheritance and more complex class structures with exercises).                   | -                              | -                                             | [Classes](https://github.com/arewadataScience/30-Days-of-Python/blob/main/16_Module_Classes_and_objects/16_classes_and_objects.md)      |
